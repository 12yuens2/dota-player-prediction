...
public class Main {
    ...
    public void run(String[] args) throws Exception {
        ...
        try {
            ...
            String fileName = args[1] + "_" + args[2] + ".csv";
            ...
            CompressorInputStream cis = getStreamForCompressedFile(args[0]);
            ...
            // }
            if (movements != null && movements.size() > 1) {
                File outputFileMovements = new File(outputDir, args[1] + "_" + args[2] + "_movement_angles.json");
                fwMovements = new FileWriter(outputFileMovements);
                bwMovements = new BufferedWriter(fwMovements);
                bwMovements.append("[");
                int size = 2;
