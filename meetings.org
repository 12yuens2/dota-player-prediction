...
- [] Create datasets split into training and test for 2-3 heroes
  - [] Make note of properties for each data set (num players and num games, num datapoints for game/pair classification)
